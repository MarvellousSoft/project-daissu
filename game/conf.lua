...
function love.conf(t)
    ...
    t.window.minwidth = 1366/3             -- Minimum window width if the window is resizable (number)
    t.window.minheight = 768/3             -- Minimum window height if the window is resizable (number)
